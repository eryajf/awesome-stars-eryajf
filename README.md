...
*   [fzdwx/infinite](https://github.com/fzdwx/infinite) - :art: cli interactive component,have progressbar,progress group,select,confirm,spinner... they easy to use,easy customization,cross-platform...
